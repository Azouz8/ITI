    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-2/3">
          <ul className="flex flex-col gap-4">
            {cart.map((item) => (
              <li
                key={item.id}
                className="flex gap-4 border border-gray-300 p-4 relative"
              >
        ...
        <div className="w-full md:w-1/3 border border-gray-300 p-6 self-start bg-gray-50">
          ...
          <button className="w-full bg-blue-600 text-white py-3 mt-6 hover:bg-blue-700 transition-colors font-semibold rounded">
            Proceed to Checkout
          </button>
        </div>
      </div>
