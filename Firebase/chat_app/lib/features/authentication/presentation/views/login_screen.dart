...
import 'package:chat_app/features/authentication/presentation/views/signup_screen.dart';
      ...
      listener: (context, state) {
        if (state is LoginSuccessState) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("Welcome Back!", textAlign: TextAlign.center),
            ),
          );
                          ...
                          children: [
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder:
                                    customOutlineInputBorderUnfocused(
                                      context,
                                    ),
