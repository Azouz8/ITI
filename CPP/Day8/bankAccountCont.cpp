...
public:
    ...
    {
        cout << "Copying accounts is not allowed" << endl;
    }
    BankAccount(BankAccount &&bankAcc)
    {
        this->accountHolderName = bankAcc.accountHolderName;
        this->accountNumber = bankAcc.accountNumber;
        this->balance = bankAcc.balance;
        bankAcc.accountHolderName = "UNKOWN";
        bankAcc.accountNumber = 0;
        bankAcc.balance = 0;
