...
where I.Ins_Id = (select top 1 Ins_Id from Instructor order by Salary)
...
--4
select * from Production.Product where Color in ('Red', 'Silver', 'Black')
...
from Production.Product where ListPrice between 100 and 120
